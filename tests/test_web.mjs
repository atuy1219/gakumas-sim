...
assert.match(towerHtml, /id="exam-progress-file"/);
...
assert.match(towerHtml, /produce_cards\.json \/ 進行JSONを読み込む/);
...
assert.match(towerHtml, /name="exam-order-mode" value="import"/);
assert.match(towerHtml, /name="exam-order-mode" value="manual"/);
