...
export function parseGrowEffectCatalog(text) {
  ...
  for (const record of records(text)) {
    ...
    result.set(id, {
      ...
      playProduceExamTriggerId: String(field(record, "playProduceExamTriggerId") ?? ""),
      playEffectProduceExamTriggerId: String(field(record, "playEffectProduceExamTriggerId") ?? ""),
      targetPlayEffectProduceExamTriggerIds: listField(record, "targetPlayEffectProduceExamTriggerIds"),
      playProduceExamEffectId: String(field(record, "playProduceExamEffectId") ?? ""),
      targetPlayProduceExamEffectIds: listField(record, "targetPlayProduceExamEffectIds"),
      produceCardStatusEnchantId: String(field(record, "produceCardStatusEnchantId") ?? ""),
      playMovePositionType: String(field(record, "playMovePositionType") ?? ""),
      effectGroupIds: listField(record, "effectGroupIds"),
      // Compatibility aliases used by the memory editor.
